...
/** @type {__VLS_StyleScopedClasses['active-hint']} */ ;
...
for (const [p, k] of __VLS_getVForSourceType((__VLS_ctx.presets))) {
    ...
    const __VLS_1 = __VLS_asFunctionalComponent(__VLS_0, new __VLS_0({
        ...
        key: (k),
        size: "small",
        type: (__VLS_ctx.store.activeScheme === k ? 'primary' : ''),
    }));
...
__VLS_asFunctionalElement(__VLS_intrinsicElements.input)({
    ...{ onInput: (...[$event]) => {
            __VLS_ctx.store.noteManualWindow();
        } },
    type: "range",
    min: (10),
    max: (3000),
...
const __VLS_15 = {
    onClick: (...[$event]) => {
        __VLS_ctx.store.resetToPartScheme();
    }
};
__VLS_11.slots.default;
var __VLS_11;
if (__VLS_ctx.store.activeScheme) {
    __VLS_asFunctionalElement(__VLS_intrinsicElements.span, __VLS_intrinsicElements.span)({
        ...{ class: "active-hint" },
    });
    (__VLS_ctx.presets[__VLS_ctx.store.activeScheme]?.desc || __VLS_ctx.store.activeScheme);
}
else {
    __VLS_asFunctionalElement(__VLS_intrinsicElements.span, __VLS_intrinsicElements.span)({
        ...{ class: "active-hint custom" },
    });
}
/** @type {__VLS_StyleScopedClasses['panel']} */ ;
...
/** @type {__VLS_StyleScopedClasses['slider-row']} */ ;
/** @type {__VLS_StyleScopedClasses['slider-row']} */ ;
/** @type {__VLS_StyleScopedClasses['reset-row']} */ ;
/** @type {__VLS_StyleScopedClasses['active-hint']} */ ;
/** @type {__VLS_StyleScopedClasses['active-hint']} */ ;
