...
export const useImagingStore = defineStore('imaging', () => {
    ...
    const savedState = ref(initialPersisted);
    ...
    const windowPresets = () => volumeData.value?.windowPresets || FALLBACK_PRESETS;
    function persist() {
        try {
    ...
    function applyWindowForPart(part) {
